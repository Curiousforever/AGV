...
if __name__ == "__main__":
    ...
    #game currently
    actions = [[True, False, True, False, 1], [False, True, False, True, 1], [False, True, True, False, -1], [True, False, False, True, -1]]
    ...
    for i in range(episodes):
        ...
        while not game.is_episode_finished():
            ...
            #currently choosing a random action from the list of actions below as a demo, input actions as required
